...
select distinct hbill_bill_number, hbill_job_code ,d.sector_code,d.Sector_Description, c.sbg_code,location, job_nature
into #billlist
from eip.sqlwom.wom_h_bills,lnt.dbo.job_master C,lnt.dbo.sector_master d

where HBILL_Job_Code= job_code
and HBILL_Bill_Date>='01-Jan-2016' and hbill_bill_date <='31-Mar-2018' 
